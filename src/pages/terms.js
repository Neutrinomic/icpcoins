...
Welcome to icpcoins.com (the "Service"), operated by VVV ("us", "we", or "our"). Your use of the Service is governed by the following Terms of Use.
...
VVV provides a platform through icpcoins.com for real-time cryptocurrency statistics and price feeds. While we aim for precision and timeliness in the data we present, we cannot guarantee its absolute accuracy or reliability.
...
VVV reserves the right at any time to modify or discontinue, temporarily or permanently, the Service (or any part of it) with or without notice at any time.

## 8. Changes to Terms
VVV reserves the right, at our sole discretion, to modify or replace these Terms at any time. By continuing to access or use our Service after those revisions become effective, you agree to be bound by the revised terms.

## 9. Entire Agreement
The Terms of Use constitute the entire agreement between you and VVV regarding the Service and supersede all prior and contemporaneous written or oral agreements between you and VVV.
